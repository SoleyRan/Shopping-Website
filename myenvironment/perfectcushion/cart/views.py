...
def cart_detail(request, total = 0, counter = 0, cart_items = None):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return False,e
    return  render(request, 'cart.html', dict(cart_items = cart_items, total = total, counter = counter, date_key = data_key, stripe_total = stripe_total, description = description))
